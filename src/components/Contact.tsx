          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden animate-fade-in">
            ...
            <div className="p-6 text-center">
              ...
              <a 
                ...
                className="bg-topvans-black hover:bg-neutral-800 text-white px-6 py-2 rounded-md inline-flex items-center justify-center gap-2 transition-all font-medium"
              >
